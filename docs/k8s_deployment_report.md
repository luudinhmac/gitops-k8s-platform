...
## 1. 🏗️ TỔNG QUAN KIẾN TRÚC & HẠ TẦNG (ARCHITECTURE OVERVIEW)
...
## 3. 🛠️ NHẬT KÝ KHẮC PHỤC CÁC SỰ CỐ PHỨC TẠP (TROUBLESHOOTING LOG)
...
## ⌨️ 4. BẢNG TRA CỨU NHANH LỆNH VẬN HÀNH (OPERATIONS CHEATSHEET)
